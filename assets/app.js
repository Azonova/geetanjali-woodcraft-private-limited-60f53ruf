window.__azonovaInit = () => {
  ...
  if (window.__azonovaParallaxHandler) {
    window.removeEventListener("scroll", window.__azonovaParallaxHandler);
  }

  if (parallaxTargets.length && !isPreviewFrame) {
    updateParallax();
    window.__azonovaParallaxHandler = updateParallax;
